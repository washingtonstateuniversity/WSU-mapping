	...
	/* for place listings */
		...
		$( "#dialog" ).dialog({
			...
			buttons: {
				"Draft": function() {
					var diaObj=$(this);
					loadStat(1,$.wsu_maps.admin.defaults.place_id,diaObj);
				},
				"Review": function() {
					var diaObj=$(this);
					loadStat(2,$.wsu_maps.admin.defaults.place_id,diaObj);

				},
				"Published": function() {
					var diaObj=$(this);
					loadStat(3,$.wsu_maps.admin.defaults.place_id,diaObj);
				},
				Cancel: function() {
		...
		$( "#sendBR" ).dialog({
			...
			buttons: {
				"Send": function() {
					var diaObj=$(this);
					sendBr($.wsu_maps.admin.defaults.place_id,diaObj);
				},
				Cancel: function() {
