...
alter table place_to_tags  drop constraint FK94806F6B7EC86500
...
alter table place_to_tags  add constraint FK94806F6B7EC86500 foreign key (tag_id) references tags 
