...
LightboxOptions = Object.extend({
    fileLoadingImage:        '../Content/images/loading.gif',
    fileBottomNavCloseImage: '../Content/images/closelabel.gif',
    ...
    breathingSize: 100,     // control the minimum space around the image box
...
var te = this.getPageSize();
        // stretch overlay to fill page and fade in
        var arrayPageSize = this.getPageSize();
        $('overlay').setStyle({height: arrayPageSize[0] + 'px'  });//arrayPageSize[3] + 'px'
    ...
    adjustImageSize: function( recall ) {
        ...
        this.overlay.setStyle({ height: arrayPageSize[0] + 'px' });
