...
alter table place  drop constraint FK5EA0A9E6AA7F828B
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK5EA0A9E67555262C]') AND parent_obj = OBJECT_ID('place'))
alter table place  drop constraint FK5EA0A9E67555262C


    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK5EA0A9E6A82DCD97]') AND parent_obj = OBJECT_ID('place'))
alter table place  drop constraint FK5EA0A9E6A82DCD97
...
alter table place  drop constraint FK5EA0A9E6E1C1DFBB
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK5EA0A9E641775A4A]') AND parent_obj = OBJECT_ID('place'))
alter table place  drop constraint FK5EA0A9E641775A4A


    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK5EA0A9E69B422D17]') AND parent_obj = OBJECT_ID('place'))
alter table place  drop constraint FK5EA0A9E69B422D17
...
alter table geometric_to_media  drop constraint FKA4F31195C032D61F
    ...
    alter table place 
        add constraint FK5EA0A9E67555262C 
        foreign key (school) 
        references schools

    alter table place 
        add constraint FK5EA0A9E6A82DCD97 
        foreign key (college) 
        references colleges
    ...
    alter table place 
        add constraint FK5EA0A9E641775A4A 
        foreign key (program) 
        references programs

    alter table place 
        add constraint FK5EA0A9E69B422D17 
