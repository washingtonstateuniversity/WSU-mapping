...
alter table place_to_programs  drop constraint FK252312D79EB7DF69
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FKFFB888DDD416FDFE]') AND parent_obj = OBJECT_ID('geometrics_to_types'))
alter table geometrics_to_types  drop constraint FKFFB888DDD416FDFE
...
alter table place  drop constraint FK5EA0A9E6E1C1DFBB
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK5EA0A9E6C56A718B]') AND parent_obj = OBJECT_ID('place'))
alter table place  drop constraint FK5EA0A9E6C56A718B
...
alter table person  drop constraint FK8C55D4CB50888406
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK7BF827393E6E682F]') AND parent_obj = OBJECT_ID('google_types_to_place_types'))
alter table google_types_to_place_types  drop constraint FK7BF827393E6E682F
...
alter table map_views  drop constraint FK78037518AA7F828B
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK780375181CBC92CD]') AND parent_obj = OBJECT_ID('map_views'))
alter table map_views  drop constraint FK780375181CBC92CD


    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FK780375187AB9C936]') AND parent_obj = OBJECT_ID('map_views'))
alter table map_views  drop constraint FK780375187AB9C936
...
alter table geometrics  drop constraint FKAA44A29FAA7F828B
    ...
    if exists (select 1 from sysobjects where id = OBJECT_ID(N'[FKAA44A29FC56A718B]') AND parent_obj = OBJECT_ID('geometrics'))
alter table geometrics  drop constraint FKAA44A29FC56A718B
...
alter table style_options  drop constraint FKAEABE8A7A160664F
    ...
    alter table geometrics_to_types 
        add constraint FKFFB888DDD416FDFE 
    ...
    alter table place 
        add constraint FK5EA0A9E6C56A718B 
    ...
    alter table google_types_to_place_types 
        add constraint FK7BF827393E6E682F 
        foreign key (google_type_id) 
        references google_types
    ...
    alter table map_views 
        add constraint FK780375181CBC92CD 
        foreign key (authors_editing) 
        references users

    alter table map_views 
        add constraint FK780375187AB9C936 
    ...
    alter table geometrics 
        add constraint FKAA44A29FC56A718B 
        foreign key (author_editing) 
        references users
